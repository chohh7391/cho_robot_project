...
"""Official arm-only UR5e Gazebo + MoveIt composition entry point."""
...
def generate_launch_description():
    ...
    robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare('cho_bringup_ur'), '/launch/bringup_gz_robot.launch.py']),
        launch_arguments={
            'ur_type': metadata['robot_type'], 'tf_prefix': '', 'load_gripper': 'false',
    ...
    moveit = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare('cho_moveit_ur'), '/launch/moveit.launch.py']),
        launch_arguments={
            'use_sim_time': 'true',
